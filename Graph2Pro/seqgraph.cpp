...
//load the graph (from FastG format generated by MetaSpades; see: http://fastg.sourceforge.net/FASTG_Spec_v1.00.pdf)
void seqgraph::loadFastGSPaDes(char *edgeseqfile)
{
        int i;
        int *edgeindex;
        ...
        num_edge = FastGSPaDes::countedge(edgeseqfile);
        cout<<"num edge to be allocated: "<<num_edge<<endl;
	...
	alledgename = (char **) smallapp::ckalloc(2 * (num_edge + 1) * sizeof(char *)); //for SPaDes
        ...
        cout<<"\n>>>Now read edge names from file "<<edgeseqfile<<endl;
        num_edge = FastGSPaDes::inputedgenames(edgeseqfile, alledgename);

        cout<<" kmersize "<<kmersize<<endl;
        num_vertex = FastGSPaDes::readedge(edgeseqfile, edge, vertex, edgeindex, num_edge, kmersize, alledgename);
        cout<<"input edge extracted: "<<num_edge<<endl;
